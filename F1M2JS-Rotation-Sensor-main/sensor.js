...
function activateVoice(alpha, beta, gamma){
    ...
    if(alpha > 120){
        let myTxt = "Why you Rotate, i like Rotation";  
    ...
    if (alpha < 20) {
        let myTxt2 = "This is so cool wow.";  
...
function showMyImage(alpha, beta, gamma){
    ...
    if(beta > 40){
        document.getElementById('myImage').src = "lam.jpg"; // show image
    }
    if ( beta < 10) {
        document.getElementById('myImage').src = "lam2.jpg";
    } else {
